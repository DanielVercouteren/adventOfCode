...
const calculateShortestManhattanDistance = () => {
  let shortestManhattanDistance = Infinity
...
run = () => {
  ...
  console.log('Coordinates found, calculating intersections...')
